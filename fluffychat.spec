%global flutter_version 3.3.0-stable
%global olm_version 3.2.12
%global commit 560ee3d39ff8197429949ff8be900de818147230
...
flutter config --no-version-check --suppress-analytics config --enable-linux-desktop
...
Exec=/opt/3rd-party/bundles/clearfraction/usr/share/fluffychat/fluffychat
Icon=fluffychat
Terminal=false
EOF
